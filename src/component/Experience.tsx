...
const experiences: ExperienceEntry[] = [
  {
    ...
    bullets: [
      "Built and maintained a role-based real estate web app with Next.js, TypeScript, Supabase, Drizzle ORM, TanStack Query, Zod, and Tailwind CSS.",
      "Supported Admin, Agent, Client, and Teammate roles with customized authorization and middleware-based protected routing.",
      "Implemented Supabase authentication with magic-link login for secure, seamless access.",
      "Integrated Stripe for payments and TanStack Query for efficient data fetching and caching.",
      "Used Zod validation for scalable forms and Drizzle schemas for type-safe database management.",
  ...
  },
  {
    ...
    bullets: [
      "Built multiple direct-to-sale e-commerce sites with HTML, Bootstrap, jQuery, and .NET.",
      "Converted Figma prototypes into responsive, mobile-friendly websites.",
